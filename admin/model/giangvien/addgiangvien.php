...
if (isset($_POST["addgiangvien"])) {
    ...
    $so_dt = $_POST['so_dt'];
    $mo_ta = $_POST['mo_ta'];
    $sql = "INSERT INTO giang_vien(ma_giang_vien,ten_giang_vien,email,so_dt,mo_ta) VALUES ('$ma_giang_vien','$ten_giang_vien','$email','$so_dt','$mo_ta')";
    pdo_execute($sql);
    ...
    <form method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" required id="exampleInputEmail1" name="so_dt" placeholder="Số điện thoại giảng viên">
            </div>
            <div class="form-group">

...
if (isset($_POST["addkhoahoc"])) {
    ...
    $sql = "INSERT INTO khoa_hoc(ten_khoa_hoc, avt, tien_hoc, mo_ta, trang_thai, ma_giang_vien, ma_danh_muc, slideshow) VALUES ('$ten_khoa_hoc','$avt','$tien_hoc','$mo_ta','$trang_thai','$ma_giang_vien','$ma_danh_muc','$slideshow')";
    pdo_execute($sql);
            ...
            <div class="form-group">
                ...
                <select name="ma_giang_vien" id="">
                    <?php
                        ...
                        extract($row);?>
                        <option value="<?=$ma_giang_vien;?>"><?=$ten_giang_vien;?></option>
                    <?php endforeach;?>
                </select>
            </div>
            <div class="form-group">
                ...
                <select name="ma_danh_muc" id="">
                    <?php
                        ...
                        foreach($danhmuc as $row):
                        extract($row);?>
                        <option value="<?=$ma_danh_muc;?>"><?=$ten_danh_muc;?></option>
                    <?php endforeach;?>
                </select>
            </div>
            <div class="form-group">
